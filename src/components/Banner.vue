<template>
  <div class="bg-amber-400 mx-4 my-3 rounded-xl">
    <div class="mx-4 max-w-7xl py-3 px-3 sm:px-6 lg:px-8">
      <div class="flex flex-wrap items-center justify-between">
        <div class="flex w-0 flex-1 items-center">
          <span class="flex rounded-lg bg-amber-400 p-2">
            <svg
          ...
          <p class="ml-3 truncate font-medium text-white">
            <span class="md:hidden">{{ props.mobileMessage }}</span>
            <span class="hidden md:inline">{{ desktopMessage }}</span>
          </p>
        </div>
        <div
